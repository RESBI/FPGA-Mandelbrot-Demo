...
set proj_name "uart_rx_scope"
set proj_dir  "./uart_rx_scope_zu4ev_proj"
set rtl_dir   "./rtl"
set xdc_file  "./constraints_vmc_rtsb_zu4ev/led.xdc"

puts "========================================"
puts " UART RX Scope Build Script"
puts " Part: $part_name"
puts "========================================"
...
add_files -fileset sources_1 [list \
    $rtl_dir/uart_tx.v \
    $rtl_dir/uart_rx_scope_top.v \
]
set_property top uart_rx_scope_top [current_fileset]

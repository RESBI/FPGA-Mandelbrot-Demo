...
set proj_name "mandelbrot_fp64_zu4ev_c8_w10_a2m1"
set proj_dir  "./fp64_zu4ev_c8_w10_a2m1_proj"
set rtl_dir   "./rtl"
set xdc_file  "./constraints_vmc_rtsb_zu4ev/mandelbrot_top.xdc"

puts "========================================"
puts " Mandelbrot FP64 ZU4EV c8 w10 a2m1 Build"
puts " Part: $part_name"
puts " Clocking: VMC_RTSB ZU4EV single-ended sys_clk at 200 MHz"
puts " Mandelbrot workers: 10"
puts " Worker contexts: 8"
puts " Worker FP units: 1 multiplier, 2 adders"
puts "========================================"
...
set_property generic {CLK_HZ=200000000 DIRECT_200MHZ=1 SCHED_MODE=1 DYNAMIC_OWNER_DEPTH=4096 CORE_COUNT=10 WORKER_CONTEXTS=8 WORKER_ADD_UNITS=2 WORKER_MUL_UNITS=1} [current_fileset]

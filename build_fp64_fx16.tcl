...
set_property generic {CLK_HZ=200000000 DIRECT_200MHZ=1 SCHED_MODE=1 DYNAMIC_OWNER_DEPTH=4096 CORE_COUNT=16 WORKER_MODE=1 FX_CONTEXTS=4 WORKER_CONTEXTS=4 RESPONSE_TILE_ROW_SPLITS=8} [current_fileset]

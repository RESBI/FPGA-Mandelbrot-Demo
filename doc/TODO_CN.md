...
本文对应 `TODO.md`，记录当前 12 Mbaud、4-worker、dynamic row、tiled response、compute tile retry 设计之后的后续工作。
...
Generic 4ctx 已在 XC7K70T 上通过板级验证，但 LUT 占用 `88.70%`。Generic 8ctx 历史上超过 xc7z010 容量，继续放大前需要更低 LUT 结构。

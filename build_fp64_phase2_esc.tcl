...
set proj_name "mandelbrot_fp64_phase2_esc"
set proj_dir  "./fp64_phase2_esc_proj"
set rtl_dir   "./rtl"
set xdc_file  "./constraints_vmc_rtsb_zu4ev/mandelbrot_top.xdc"

puts "========================================"
puts " Mandelbrot FP64 Phase 2 Build (early-escape on squares)"
puts " Part: $part_name"
...
puts " Response retry row splits: 8"
puts "========================================"
...
set_property generic {CLK_HZ=200000000 DIRECT_200MHZ=1 SCHED_MODE=1 DYNAMIC_OWNER_DEPTH=4096 CORE_COUNT=12 WORKER_CONTEXTS=8 RESPONSE_TILE_ROW_SPLITS=8} [current_fileset]

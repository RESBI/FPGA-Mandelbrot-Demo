...
set_property generic "CLK_HZ=200000000 DIRECT_200MHZ=1 SCHED_MODE=1 DYNAMIC_OWNER_DEPTH=4096 CORE_COUNT=$core_count WORKER_CONTEXTS=$worker_contexts" [current_fileset]
